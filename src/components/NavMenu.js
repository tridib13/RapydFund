...
import '../pages/css/NavMenu.css'

export default function NavMenu() {
    return (
        <div style={{width: 270, height: '90%', borderRadius: 30, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', fontFamily: 'Montserrat'}} className="menu-container-crowd">
            <div className="inner" style={{width: '60%', height: '80%', display: 'flex', justifyContent: 'space-around', flexDirection: 'column'}}>
                ...
                <div className="menu" style={{color: 'white', fontWeight: 500, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '60%', fontSize: 14}}>
                    ...
                    <p>Goal</p>
                    <p>Withdraw</p>
                    <Link to="/crowdfunder/blockchain" style={{color: 'white', fontWeight: 500, textDecoration: 'none'}}><p>Blockchain</p></Link>
                    <p>Settings</p>
                </div>
